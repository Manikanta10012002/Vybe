...
function Nav ()  {
  ...
  return (
    <div className='fixed bottom-5 left-1/2 transform -translate-x-1/2 w-[90%] lg:w-[40%] h-[80px] bg-black flex justify-around items-center rounded-full shadow-2xl shadow-[#000000] z-[100]' >
